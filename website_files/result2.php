...
$var_teacher = $_POST['teacher'];

$freelance_query = "SELECT f.rate as rate, CONCAT(t.fname, ' ', t.lname) as full_name from teacher as t
JOIN freelance as f on t.id = f.tutorID
WHERE t.id = '$var_teacher';";


$freelance_result = mysqli_query($con, $freelance_query);



while($row = mysqli_fetch_assoc($freelance_result)){
    echo "<thead>" . "<tr>" . "<th>" . "Current rate for tutor " . $row['full_name'] . "</th>" . "</tr>" . "</thead>";
    echo "<tbody>" . "<tr>" . "<td>" . $row['rate'] . "</td>" . "</tr>" . "</tbody>" . "<br>";
};
